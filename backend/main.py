...
from api.routes import agents_router, analysis_router, documents_router, evaluation_router, routing_router, settings_router
...
app.include_router(agents_router, prefix="/api/agents", tags=["agents"])  # TEMPORARY
